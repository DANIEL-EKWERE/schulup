...
Iphone1415ProEightyoneController controller =
    Get.put<Iphone1415ProEightyoneController>(
      Iphone1415ProEightyoneController(),
    );

class RFIDReaderCheckOutScreen extends StatefulWidget {
  @override
  State<RFIDReaderCheckOutScreen> createState() =>
      _RFIDReaderCheckOutScreenState();
}
