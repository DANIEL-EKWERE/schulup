...
class Iphone1415ProSeventyeightScreen
    extends GetWidget<Iphone1415ProSeventyeightController> {
  const Iphone1415ProSeventyeightScreen({Key? key}) : super(key: key);
  ...
  Widget _buildDropSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          SizedBox(height: 4.h),
          Text("lbl_drop".tr, style: theme.textTheme.titleLarge),
        ],
      ),
    );
  }
